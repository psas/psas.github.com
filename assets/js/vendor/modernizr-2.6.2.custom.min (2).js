...
window.Modernizr = function(a, b, c) {
        ...
        function A(a, b, d) { for (var e in a) { var f = b[a[e]]; if (f !== c) return d === !1 ? a[e] : y(f, "function") ? f.bind(d || b) : f } return !1 } var d = "2.6.2",
            e = {},
            f = !0,
            g = b.documentElement,
            h = "modernizr",
            ...
            s = r.slice,
            t, u = {}.hasOwnProperty,
            v;!y(u, "undefined") && !y(u.call, "undefined") ? v = function(a, b) { return u.call(a, b) } : v = function(a, b) { return b in a && y(a.constructor.prototype[b], "undefined") }, Function.prototype.bind || (Function.prototype.bind = function(b) { var c = this; if (typeof c != "function") throw new TypeError; var d = s.call(arguments, 1),
                e = function() { if (this instanceof e) { var a = function() {};
                        a.prototype = c.prototype; var f = new a,
                            g = c.apply(f, d.concat(s.call(arguments))); return Object(g) === g ? g : f } return c.apply(b, d.concat(s.call(arguments))) }; return e }), o.rgba = function() { return w("background-color:rgba(150,255,150,.5)"), z(j.backgroundColor, "rgba") }, o.hsla = function() { return w("background-color:hsla(120,40%,100%,.5)"), z(j.backgroundColor, "rgba") || z(j.backgroundColor, "hsla") }, o.textshadow = function() { return b.createElement("div").style.textShadow === "" }, o.opacity = function() { return x("opacity:.55"), /^0.55$/.test(j.opacity) }, o.svg = function() { return !!b.createElementNS && !!b.createElementNS(n.svg, "svg").createSVGRect }; for (var B in o) v(o, B) && (t = B.toLowerCase(), e[t] = o[B](), r.push((e[t] ? "" : "no-") + t)); return e.addTest = function(a, b) { if (typeof a == "object")
            ...
            function(a, b) {
                ...
                a.html5 = r, q(b) }(this, b), e._version = d, e._prefixes = m, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + r.join(" ") : ""), e }(this, this.document),
    function(a, b, c) {
